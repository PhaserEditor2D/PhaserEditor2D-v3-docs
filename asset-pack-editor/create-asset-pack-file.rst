...
The project templates provided by |PhaserEditor|_ contain at least one |AssetPackFile|_. You can use it to configure the assets of your project. However, if you like to load a group of assets at a certain moment of the game, and another group in another moment of the game, you can create a new |AssetPackFile|_.
...
.. image:: ../images/asset-pack-editor-new-file-04072020.webp

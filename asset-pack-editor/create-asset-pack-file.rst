...
The project templates provided by |PhaserEditor|_ contain at least one |AssetPackFile|_. You can use it to configure the assets of your project. However, if you like to load a group of assets at certain moment of the game, and other group of assets in other moment of the game, you can create a new |AssetPackFile|_.
...
.. image:: ../images/asset-pack-editor-new-file-04072020.png

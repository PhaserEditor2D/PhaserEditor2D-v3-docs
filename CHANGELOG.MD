...
* Adds Shader Effects topic.
* Mention the Play button saves all editors.
* Adds the new numeric input methods.

## v3.66.0 - Jan 10, 2024

* Adds the Action Target Config topic.
* Adds game object display name.
* Adds variable section Display Name topic.
* Adds user component object display format topic.

## v3.65.0 - Dec 13, 2023

* Adds script node libraries section.
* Adds scene and prefab display properties.
* Adds user component display name property.

## v3.64.0 - Nov 10, 2023

* Adds sprite animation chapters.

## v3.63.0 - Sep 30, 2023

* Adds Spine chapter.
* Adds the Spine events to the Event property type.
...
* Updates the Add Property button and dialog.
* Updates commands palette.
...
* Updates the Object List chapter.
* Updates nested prefab section with new LOCAL scope.
* Updates Variable section chapter with new LOCAL scope.
* Adds the hit area chapter.
* Moves manipulation tools for separated files.
* Update scripts chapter: now the Blocks view doesn't show the script node prefabs.
...
* ScriptsNode section.
* Shows Scene instead of Display List. 
* Removes the Parent property section.
* Adds the Nine Slice game object chapter.
* Creates the Size properties chapter.
* Adds section about pixelArt rendering command.

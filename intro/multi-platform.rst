...
At this moment, we have different back-end implementations, one for the desktop or private networks (for a single user), and one for the cloud, that allows multiple users.

The back-ends are closed (no source available to the public) and are commercial.

The front-end is the same for all back-ends. It is the most important and bigger part of the IDE. It is open-source, has the MIT license and we welcome any collaboration on it. It is hosted on GitHub and is the main place to request features or report bugs.
...
The back-end for desktop and private networks is a small native program available for all the main platforms: Windows, macOS, and Linux. It is the main product we offer to the community. You can download it from our website and run it on your desktop or your private server.

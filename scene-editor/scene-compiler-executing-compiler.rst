...
* The **Compile Scenes** command compiles all the scene files of the project. You can execute the command with the ``Ctrl+Alt+B`` keys. It is also available in the |MainMenu|_ and the `FilesView context menu <../workbench/files-view.html#context-menu>`_.
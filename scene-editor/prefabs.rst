...
A prefab_ is a key concept in the |SceneEditor|_. It allows to create reusable, customized objects. It borrows some concepts from the |Unity|_ prefabs.
...
Actually, a prefab_ is literally a class. If you look into the code generated by the |SceneCompiler|_, a prefab_ scene is compiled into a class that extends a Phaser_ built-in type or another prefab_ class. And |PrefabInstances|_ are just instances of the generated class.

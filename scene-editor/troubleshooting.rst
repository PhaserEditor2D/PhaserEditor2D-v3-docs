...
Another common problem is that when you execute the game, the scene is different. A possible cause could be that the scene was not re-compiled after a prefab_ file change.

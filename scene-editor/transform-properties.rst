...
* The `X <https://photonstorm.github.io/phaser3-docs/Phaser.GameObjects.Components.Transform.html#x__anchor>`_ and `Y <https://photonstorm.github.io/phaser3-docs/Phaser.GameObjects.Components.Transform.html#x__anchor>`_ of the position. See the `position manipulation tool <manipulation-tools.html#position-tool>`_.
...
* The `angle <https://photonstorm.github.io/phaser3-docs/Phaser.GameObjects.Components.Transform.html#angle__anchor>`_, in degrees. The default values is ``0``. See the `angle manipulation tool <manipulation-tools.html#angle-tool>`_.
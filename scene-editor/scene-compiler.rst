...
Traditionally, a game engine has its own file format to create scenes and part of its API is focused on the integration with a scene editor.
...
For the |SceneEditor|_, we use a custom scene-file format, but instead of create a custom library to parse and create the Phaser_ scenes on the fly, we created a compiler.
...
* Your game don't need to load an extra, third-party library.
...
* You can customize certain aspects of the generated code and/or insert your own code.
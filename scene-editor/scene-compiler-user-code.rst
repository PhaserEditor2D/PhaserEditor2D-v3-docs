...
The |SceneEditor|_ helps to build game levels, but it is faraway to cover all aspects of a game. Especially, the game logic should be implemented by you, writing code.
...
We designed the |SceneCompiler|_ to allow you merging the generated code with your own code, in the same file.

The concept is simple:

* The |SceneCompiler|_ creates the initial JavaScript file.

* The initial file contains protected regions, where the user can insert its own code. These regions are delimited by JavaScript comments like ``/* START-USER-CODE */`` and ``/* END-USER-CODE */``.

* You can insert your own code inside the protected regions. 
